...
eagle=../temp/Eagle_v2.4.1/eagle
ggmap=../temp/Eagle_v2.4.1/tables/genetic_map_hg38_withX.txt.gz
vcf=../temp/genome1K.phase3.SNP_AF5e2.chr1toX.hg38.vcf.gz
panel=../temp/1000G_hg38
