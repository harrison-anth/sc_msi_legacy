...
plots <-  marrangeGrob(
list(  print(FeaturePlot(s_obj,features=c('sensor2'),cols=c('blue','red')) + 
...
#plots_final <- print(annotate_figure(plots_final,top=text_grob(paste0(sample_info$filename,'; ',sample_info$site,'; ',
...
ggsave(paste0('../images/',sample,'_msi_plots.pdf'),plots,width=3, height=3, units="in", scale=10)
